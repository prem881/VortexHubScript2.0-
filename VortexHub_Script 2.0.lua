...
-- Toggle: Anti-AFK
Tabs.Main:AddToggle("AFK", { Title = "ป้องกัน AFK", Default = false }):OnChanged(function(v)
    _G.AFK = v
    if v then
        -- เริ่มต้นฟังก์ชัน Anti-AFK เมื่อเปิดใช้งาน
        ...
        print("AFK Protection Enabled.")
    else
        print("AFK Protection Disabled.")
    end
end)
